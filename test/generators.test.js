    ...
    describe('paths', function () {
      ...
      var generatedRoutes = generators.routes(controllers, {routes: {
        ...
        'put /user/:id': {
            ...
            swagger: {
                body: modifiedAttr,
                tag: {name: 'Overriden'} // tag attribute should override autogenerated tags
            }
        },
        // route with standalone action. tag attribute should override autogenerated tags
        'get /user/stand-alone': {
        ...
        it('tag attribute should be used for standalone actions if tag attribute is specified in route', function (done) {
            assert.deepEqual(actual['/user/stand-alone'].get.tags, ['User'], "The tag must be array of the tag attribute on the route ");
            done();
        });

        it('tag attribute should override autogenerated tag if tag attribute is specified in route', function (done) {
            assert.deepEqual(actual['/user/{id}'].put.tags, ['Overriden'], "The tag must be array of the tag attribute on the route ");
            done();
        });
