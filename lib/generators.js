...
function _generateModels(models) {
    ...
    _.forEach(models, function (model) {
        ...
        if (model.globalId) {
            ...
            tags.push({name: model, identity: model});
        }
    });
    ...
    _.forEach(generated_routes, function (routes, identity) {
        _.forEach(routes, function (route) {
          ...
          if(!route.custom){ // if not from routes.js use the default custom blueprint maps
            ...
            var consumes = route.consumes ? route.consumes : ['application/json'];
            var produces = route.produces ? route.produces : ['application/json'];
...
function _getQueryParamsFromParameters(parameters) {
    ...
    _.forEach(parameters, function (parameter) {
        var obj = {
            ...
            default: parameter.default ? parameter.default : null
        }
        if (obj.default == null) delete obj.default
        params.push(obj);
    });
